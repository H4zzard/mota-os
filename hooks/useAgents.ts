...
import {
  ...
  Rocket, HeadphonesIcon, LayoutList, Search, Globe, Bot,
} from "lucide-react"
...
function mapRow(row: ApiAgent): AgentWithConfig {
  ...
  return {
    ...
    systemPrompt:    cfg?.system_prompt ?? `Você é ${row.short_name}, assistente de IA do Grupo Mota Educação. Responda em português.`,
